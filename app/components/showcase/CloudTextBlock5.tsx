  ...
  return (
    <div className="">
      <div className="container mx-auto px-4 ">
        <h1 className="text-3xl font-bold mb-6  text-pink-600">Prismatic Text Animation</h1>
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-8">
          <PrismTextBlock />
        </div>
        <div className="mt-6 text-center text-gray-600 max-w-2xl mx-auto">
          <p>
            This prismatic text animation presents various aspects of our services 
            in a dynamic and captivating way. Each text appears, scales smoothly, 
            and fades away with a unique blur effect. The use of gradients 
            and motion creates a vibrant, prismatic effect that captures 
